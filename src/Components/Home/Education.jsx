...
const Education = () => {
  return (
    <div data-aos="zoom-in-up" id="education">
        <marquee>
       ...
       <div className="mb-10">
       <div data-aos="fade-up" className="education-card border w-full rounded-xl text-center py-5 bg-white hover:bg-black mb-5">
        ...
        <div data-aos="fade-left" className="education-card border w-full rounded-xl text-center py-5 bg-white hover:bg-black mb-5">
        ...
        <div data-aos="fade-right" className="education-card border w-full rounded-xl text-center py-5 bg-white hover:bg-black">
